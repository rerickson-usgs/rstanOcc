...
#include "stanExports_occupancyBernoulli.h"

RCPP_MODULE(stan_fit4occupancyBernoulli_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_occupancyBernoulli")
