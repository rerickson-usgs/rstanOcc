...
#include "stanExports_logistic_target_stan.h"

RCPP_MODULE(stan_fit4logistic_target_stan_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_logistic_target_stan")
