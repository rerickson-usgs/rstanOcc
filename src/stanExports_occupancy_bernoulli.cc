...
#include "stanExports_occupancy_bernoulli.h"

RCPP_MODULE(stan_fit4occupancy_bernoulli_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_occupancy_bernoulli")
