...
#include "stanExports_occupancy_mu_binomial.h"

RCPP_MODULE(stan_fit4occupancy_mu_binomial_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_occupancy_mu_binomial")
