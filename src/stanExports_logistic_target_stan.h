...
namespace model_logistic_target_stan_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_logistic_target_stan");
    reader.add_event(17, 15, "end", "model_logistic_target_stan");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_logistic_target_stan : public prob_grad {
private:
        int N;
        vector_d x;
        std::vector<int> y;
public:
    model_logistic_target_stan(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_logistic_target_stan_namespace::model_logistic_target_stan";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int index = 1; index <= N; ++index) {
                ...
                lp_accum__.add(binomial_logit_log(get_base1(y, index, "y", 1), 1, (alpha + (beta * get_base1(x, index, "x", 1)))));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_logistic_target_stan_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_logistic_target_stan";
    }
...
typedef model_logistic_target_stan_namespace::model_logistic_target_stan stan_model;
